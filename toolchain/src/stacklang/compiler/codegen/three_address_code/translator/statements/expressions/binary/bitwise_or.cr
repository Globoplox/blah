struct Stacklang::ThreeAddressCode::Translator
  def translate_bitwise_or(expression : AST::Binary) : {Address, Type}?
    ...
    t0 = anonymous 1
    @tacs << Nand.new left_address, left_address, t0, expression
    t1 = anonymous 1
    @tacs << Nand.new right_address, right_address, t1, expression
    t2 = anonymous 1
    @tacs << Nand.new t0, t1, t2, expression
    {t2, typeinfo}
  end
end
